...
| `--cooldown-hours` | Don't re-triage an error signature seen within the last N hours (0 disables). Prevents scheduled runs from re-commenting on known errors; state in `~/.raven/processed-errors.json` | `168` |
